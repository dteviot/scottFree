...
public class ItemStaticData {
     ...
     */
    public ItemStaticData(AdventureFileReader reader, AdventureStaticData staticData) throws IOException {
    ...
    public int getStartLocation() { return mStartLocation; }
    public int getNounCode() { return mNounCode; }
}
