...
public class AdventureStaticData {
    ...
    public int numItems() { return mItemStaticData.length; }
    public int numActions() { return mGameCode.length / 8; }
    public int numWords() { return mVerbs.length; }
    
    public String[] getMessages() { return mMessages; }
    public Room[] getRooms() { return mRooms; }
    public String[] getVerbs() { return mVerbs; }
    public String[] getNouns() { return mNouns; }
    public int[] getGameCode() { return mGameCode; }

    public void setMessages(String[] messages) { mMessages = messages; }
    
    public int getMaxCarry() { return mMaxCarry; }
    public int getPlayerStartRoom() { return mPlayerStartRoom; }
    public int getNumTreasures() { return mNumTreasures; }
    public int getLightRefill() { return mLightRefill; }
    public int getTreasureRoom() { return mTreasureRoom; }
}
