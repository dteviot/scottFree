...
public class AdventureGame {
	...
	boolean atCarryLimit() { return CountCarried() >= mStaticData.getMaxCarry(); }

	Room getRoom(int index) { return mStaticData.getRooms()[index]; };
	int GameCode(int index) { return mStaticData.getGameCode()[index]; }
	...
	/* Output Subsystem */
	ScottCanvas mDrawingAgent;

	public AdventureGame(ScottCanvas output) {
		Params = new int[5];
