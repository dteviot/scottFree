...
public class Item {
  ...
  public String getName() {
    return mStaticData.getName();
  }

  public int getStartLocation() {
    return mStaticData.getStartLocation();
  }

  public int getNounCode() {
    return mStaticData.getNounCode();
  }
  ...
  public boolean isIn(int location) {
    return mLocation == location;
  }

  public boolean isDestroyed() {
    return mLocation == Destroyed;
  }

  public boolean isAtStartLocation() {
    return mLocation == getStartLocation();
  }
}
